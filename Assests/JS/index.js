  ...
  <body class="neterror">
    ...
    <div class="container">
      <div id="text-container">
        ...
        <!-- Short Description -->
        <p id="errorShortDesc">We can’t connect to the server at rdggreregerggre.com.</p>
        ...
        <p id="learnMoreContainer" hidden="">
          <a id="learnMoreLink" target="_blank" rel="noopener noreferrer" data-telemetry-id="learn_more_link" data-l10n-id="neterror-learn-more-link" href="https://support.mozilla.org/1/firefox/120.0.1/Linux/en-US/connection-not-secure">Learn more…</a>
        </p>
